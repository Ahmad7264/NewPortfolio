...
const SKILL_CATEGORIES: SkillTimelineCategory[] = [
  {
    ...
    tagline: 'Modern component architecture & responsive web development',
    color: '#6366f1',
    icon: <Layout size={16} />,
    technologies: ['React.js', 'Next.js', 'Vite', 'TypeScript', 'JavaScript', 'HTML5', 'CSS3', 'Tailwind CSS'],
  },
  {
    number: '02',
    id: 'backend',
    label: 'Backend Development',
    tagline: 'Enterprise services, RESTful endpoint design & API integrations',
    color: '#8b5cf6',
    icon: <Server size={16} />,
    technologies: ['Java', 'Spring', 'Spring Boot', 'Node.js', 'Express.js', 'RESTful APIs'],
  },
  {
    number: '03',
    id: 'languages',
    ...
    color: '#06b6d4',
    icon: <Code2 size={16} />,
    technologies: ['Java', 'C', 'Python', 'JavaScript', 'TypeScript'],
  },
  {
    number: '04',
    id: 'databases',
    ...
    technologies: ['MySQL', 'PostgreSQL', 'Cloudflare KV', 'DBMS Architecture'],
  },
  {
    number: '05',
    id: 'devops',
    label: 'Development & Deployment',
    tagline: 'Containerization, version control, IDEs & production pipelines',
    color: '#f59e0b',
    icon: <Cloud size={16} />,
    technologies: ['Git', 'Docker', 'Netlify', 'Render', 'VS Code', 'IntelliJ IDEA', 'Google Colab', 'Cloudflare Workers', 'Capacitor'],
  },
  {
    number: '06',
    id: 'aiml',
    label: 'AI & CS Fundamentals',
    tagline: 'Generative AI, machine learning, data structures & algorithms',
    color: '#10b981',
    icon: <Brain size={16} />,
    technologies: ['Generative AI', 'Machine Learning', 'Data Analysis', 'Data Structures & Algorithms', 'OOP', 'Testing & Debugging'],
  },
];
